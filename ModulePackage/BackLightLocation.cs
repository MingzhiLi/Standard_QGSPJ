...
namespace ModulePackage
{
    public class BackLightLocation : ModuleBase
    {
        ...
        public static bool BolbDevationCalc(Point4D dst, Point2D delta, double srcAngle,
            double dstAngle, double r, double threadX, double threadY,
            double botAngle, double displayAngle, double blAngle, int id, bool ifRecord, 
            out Point2D deltaDst,out Point4D pt4Dst)
        {
            ...
            try
            {
                ...
                {
                    pt4Dst = new Point4D(deltaDst.DblValue1, deltaDst.DblValue2, 0, r) + dst;
                }
