...
namespace Main
{
    public partial class BaseDealComprehensiveResult_Main
    {
        ...
        /// <param name="blResult">信息类型，默认为true</param>
        public void ShowStateCamera(string info, bool blResult = true)
        {
            ShowState(info);
            g_UCDisplayCamera.ShowResult(info, blResult);
        }
        /// <summary>
        /// 同时在相机窗体及报警窗口显示信息
        /// </summary>
        /// <param name="info">要显示的信息</param>
        /// <param name="blResult">信息类型，默认为false</param>
        public void ShowAlarmCamera(string info, bool blResult = false)
        {
            ShowAlarm(info);
            g_UCDisplayCamera.ShowResult(info, blResult);
        }
        ...
        public void ShowWinError(string str)
        {
            try
            {
                ShowAlarm(str);
