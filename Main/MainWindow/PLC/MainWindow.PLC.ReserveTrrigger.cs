    ...
    partial class MainWindow
    {
        ...
        protected override void LogicPLC_Inst_Reserve9_event(TriggerSource_enum trrigerSource_e, int i)
        {
            try
            {
                try
                {
                    ShowState("PLC触发开启校准模式");
                    BaseDealComprehensiveResult_Main.ResetResidueCalibFlag();
                    ///清空单目校准结果List
                    //DealComprehensiveResult6.PCalibPos1_L?.Clear();
                    //DealComprehensiveResult6.PCalibPos2_L?.Clear();
                    ///将软件设置为校准模式
